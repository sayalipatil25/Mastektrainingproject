...
* The original package name 'com.training.antique.store.demo-backend-store' is invalid and this project uses 'com.training.antique.store.demobackendstore' instead.
